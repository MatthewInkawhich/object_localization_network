...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round1/restricted_voc5_cz_lateqflwbbl2_noft_2x_r1_p30/restricted_voc5_annotations_for_round2_p30.json',
...
work_dir='./out/oln_box/round2/restricted_voc5_cz_lateqflwbbl2_noft_2x_r2_p30_p30'

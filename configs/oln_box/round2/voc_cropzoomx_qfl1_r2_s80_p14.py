...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round1/voc_cropzoomx_qfl1_r1_s80/annotations_for_round2_p14.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round1/voc_cropzoomx_qfl1_r1_s80/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round2/voc_cropzoomx_qfl1_r2_s80_p14'

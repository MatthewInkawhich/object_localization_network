...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round1/animal_ssl_p25_s1_cz_lateqflwbbl2_noft_2x_r1_p30/annotations_for_round2_p30.json',
...
work_dir='./out/oln_box/round2/animal_ssl_p25_s1_cz_lateqflwbbl2_noft_2x_r2_p30_p30'

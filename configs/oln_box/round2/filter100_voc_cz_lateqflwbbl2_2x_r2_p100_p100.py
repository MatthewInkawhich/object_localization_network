...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round1/filter100_voc_cz_lateqflwbbl2_2x_r1_p100/filter100_annotations_for_round2_p100.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round1/filter100_voc_cz_lateqflwbbl2_2x_r1_p100/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round2/filter100_voc_cz_lateqflwbbl2_2x_r2_p100_p100'

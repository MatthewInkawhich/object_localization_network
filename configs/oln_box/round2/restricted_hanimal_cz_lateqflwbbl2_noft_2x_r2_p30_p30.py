...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round1/restricted_hanimal_cz_lateqflwbbl2_noft_2x_r1_p30/restricted_hanimal_annotations_for_round2_p30.json',
        is_class_agnostic=True,
        train_class='hanimal',
        eval_class='nonhanimal',
        type=dataset_type,
...
work_dir='./out/oln_box/round2/restricted_hanimal_cz_lateqflwbbl2_noft_2x_r2_p30_p30'

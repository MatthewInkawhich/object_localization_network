...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round1/vehicle_cz_lateqflwbbl2_2x_r1_p20/annotations_for_round2_p20.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round1/vehicle_cz_lateqflwbbl2_2x_r1_p20/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round2/vehicle_cz_lateqflwbbl2_2x_r2_p20_p20'

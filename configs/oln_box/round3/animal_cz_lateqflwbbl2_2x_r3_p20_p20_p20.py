...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round2/animal_cz_lateqflwbbl2_2x_r2_p20_p20/annotations_for_round3_p20.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round2/animal_cz_lateqflwbbl2_2x_r2_p20_p20/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round3/animal_cz_lateqflwbbl2_2x_r3_p20_p20_p20'

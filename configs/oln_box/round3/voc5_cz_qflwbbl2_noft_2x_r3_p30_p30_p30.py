...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round2/voc5_cz_qflwbbl2_noft_2x_r2_p30_p30/annotations_for_round3_p30.json',
...
work_dir='./out/oln_box/round3/voc5_cz_qflwbbl2_noft_2x_r3_p30_p30_p30'

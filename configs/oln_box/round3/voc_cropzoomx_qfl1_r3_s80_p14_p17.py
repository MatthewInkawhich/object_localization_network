...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round2/voc_cropzoomx_qfl1_r2_s80_p14/annotations_for_round3_p17.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round2/voc_cropzoomx_qfl1_r2_s80_p14/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round3/voc_cropzoomx_qfl1_r3_s80_p14_p17'

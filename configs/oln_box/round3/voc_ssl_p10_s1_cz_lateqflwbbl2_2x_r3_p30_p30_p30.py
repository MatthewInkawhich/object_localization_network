...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round2/voc_ssl_p10_s1_cz_lateqflwbbl2_2x_r2_p30_p30/annotations_for_round3_p30.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round2/voc_ssl_p10_s1_cz_lateqflwbbl2_2x_r2_p30_p30/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round3/voc_ssl_p10_s1_cz_lateqflwbbl2_2x_r3_p30_p30_p30'

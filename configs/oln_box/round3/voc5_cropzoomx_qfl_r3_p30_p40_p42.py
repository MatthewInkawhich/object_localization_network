...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round2/voc5_cropzoomx_qfl_r2_p30_p40/annotations_for_round3_p42.json',
...
work_dir='./out/oln_box/round3/voc5_cropzoomx_qfl_r3_p30_p40_p42'

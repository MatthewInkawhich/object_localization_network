...
model = dict(
    ...
    rpn_head=dict(
        ...
        bbox_coder=dict(
            ...
            normalizer=1.0,),
        loss_cls=dict(
            type='CrossEntropyLoss', use_sigmoid=True, loss_weight=lambda_cls*1.0),
        reg_decoded_bbox=True,
        loss_bbox=dict(type='IoULoss', linear=True, loss_weight=10.0),
        objectness_type='Centerness',
        loss_objectness=dict(type='L1Loss', loss_weight=(1-lambda_cls)*1.0),
        #loss_objectness=dict(
        #    type='QualityOnlyFocalLoss',
        #    beta=2.0,
        #    reduction='mean',
        #    loss_weight=(1-lambda_cls)*1.0),
        ),
    roi_head=dict(
        type='OlnRoIHead',
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                use_sigmoid=False, 
                loss_weight=lambda_cls*1.0,
                ),
            loss_bbox=dict(type='L1Loss', loss_weight=1.0),
            bbox_score_type='BoxIoU',  # 'BoxIoU' or 'Centerness'
            loss_bbox_score=dict(type='L1Loss', loss_weight=(1-lambda_cls)*1.0),
...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round2/restricted_voc_cz_hybrid_lc10_wbbl2_2x_r2_p30_p30/restricted_voc_annotations_for_round3_p30.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round2/restricted_voc_cz_hybrid_lc10_wbbl2_2x_r2_p30_p30/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round3/restricted_voc_cz_hybrid_lc10_wbbl2_2x_r3_p30_p30_p30'

...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/voc_imagenet_combined_r0/combined_annotations_for_round1_s82.json',
        img_prefix='data/coco_imagenet/images/',
...
log_level = 'INFO'
load_from = 'out/oln_box/round0/voc_imagenet_combined_r0/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round1/voc_imagenet_combined_r1_s82'

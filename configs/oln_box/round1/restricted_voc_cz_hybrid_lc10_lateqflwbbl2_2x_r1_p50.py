...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/voc_cz_hybrid_lc10_2x_r0/restricted_voc_annotations_for_round1_p50.json',
...
work_dir='./out/oln_box/round1/restricted_voc_cz_hybrid_lc10_lateqflwbbl2_2x_r1_p50'

...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/voc_cropzoomx_qfl1/annotations_for_round1_p10.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round0/voc_cropzoomx_qfl1/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round1/voc_cropzoomx_qfl1_r1_p10'

_base_ = [
    ...
    '../../_base_/schedules/schedule_ft6.py', 
...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/voc_cropzoomx/annotations_for_round1_s80.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round0/voc_cropzoomx/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round1/voc_cropzoomx_ft6_r1_s80'

...
data = dict(
    ...
    auxiliary=dict(
        ann_file='out/oln_box/round0/voc_imagenet_r0/auxiliary_annotations_for_round1_s78.json',
        img_prefix='data/imagenet/images/',
        is_class_agnostic=True,
        train_class='voc',
        eval_class='nonvoc',
        type=dataset_type,
...
work_dir='./out/oln_box/round1/voc_imagenet_r1_s8078'

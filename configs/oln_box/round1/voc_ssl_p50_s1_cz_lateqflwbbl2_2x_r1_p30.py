...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/voc_ssl_p50_s1_cz_2x_r0/annotations_for_round1_p30.json',
...
work_dir='./out/oln_box/round1/voc_ssl_p50_s1_cz_lateqflwbbl2_2x_r1_p30'

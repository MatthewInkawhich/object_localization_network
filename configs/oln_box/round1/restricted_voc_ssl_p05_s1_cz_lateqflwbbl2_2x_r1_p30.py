...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/voc_ssl_p05_s1_cz_2x_r0/restricted_voc_annotations_for_round1_p30.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round0/voc_ssl_p05_s1_cz_2x_r0/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round1/restricted_voc_ssl_p05_s1_cz_lateqflwbbl2_2x_r1_p30'

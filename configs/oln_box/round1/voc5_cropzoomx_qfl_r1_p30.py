...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/voc5_cropzoomx/annotations_for_round1_p30.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round0/voc5_cropzoomx/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round1/voc5_cropzoomx_qfl_r1_p30'

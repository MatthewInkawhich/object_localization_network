...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round0/hcoco_cz_hybrid_lc50_2x_r0/restricted_hcoco_annotations_for_round1_p30.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round0/hcoco_cz_hybrid_lc50_2x_r0/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round1/restricted_hcoco_cz_hybrid_lc50_lateqflwbbl2_2x_r1_p30'

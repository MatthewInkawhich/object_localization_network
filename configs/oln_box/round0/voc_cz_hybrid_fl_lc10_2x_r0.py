...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_cls=dict(type='FocalLoss', use_sigmoid=True, gamma=2.0, alpha=0.25, loss_weight=lambda_cls*1.0),
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            #    ),
            loss_cls=dict(type='FocalLoss', use_sigmoid=False, gamma=2.0, alpha=0.25, loss_weight=lambda_cls*1.0),
...
work_dir='./out/oln_box/round0/voc_cz_hybrid_fl_lc10_2x_r0'

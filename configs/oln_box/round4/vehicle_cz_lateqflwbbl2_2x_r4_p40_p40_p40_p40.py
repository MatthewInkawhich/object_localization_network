...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round3/vehicle_cz_lateqflwbbl2_2x_r3_p40_p40_p40/annotations_for_round4_p40.json',
...
log_level = 'INFO'
load_from = 'out/oln_box/round3/vehicle_cz_lateqflwbbl2_2x_r3_p40_p40_p40/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box/round4/vehicle_cz_lateqflwbbl2_2x_r4_p40_p40_p40_p40'

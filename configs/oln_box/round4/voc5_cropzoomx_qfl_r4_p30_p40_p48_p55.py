...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box/round3/voc5_cropzoomx_qfl_r3_p30_p40_p48/annotations_for_round4_p55.json',
...
work_dir='./out/oln_box/round4/voc5_cropzoomx_qfl_r4_p30_p40_p48_p55'

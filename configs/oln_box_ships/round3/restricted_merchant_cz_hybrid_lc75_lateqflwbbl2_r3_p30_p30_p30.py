...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round2/restricted_merchant_cz_hybrid_lc75_lateqflwbbl2_r2_p30_p30/restricted_merchant_annotations_for_round3_p30.json',
        img_prefix=data_root + 'VOC_Format/JPEGImages/',
        is_class_agnostic=True,
        train_class='merchant',
        eval_class='nonmerchant',
        type=dataset_type,
...
log_level = 'INFO'
load_from = 'out/oln_box_ships/round2/restricted_merchant_cz_hybrid_lc75_lateqflwbbl2_r2_p30_p30/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box_ships/round3/restricted_merchant_cz_hybrid_lc75_lateqflwbbl2_r3_p30_p30_p30'

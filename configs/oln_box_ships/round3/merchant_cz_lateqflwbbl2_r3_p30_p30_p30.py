...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round2/merchant_cz_lateqflwbbl2_r2_p30_p30/annotations_for_round3_p30.json',
...
log_level = 'INFO'
load_from = 'out/oln_box_ships/round2/merchant_cz_lateqflwbbl2_r2_p30_p30/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box_ships/round3/merchant_cz_lateqflwbbl2_r3_p30_p30_p30'

...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round0/warship_cz_hybrid_lc75_r0/restricted_warship_annotations_for_round1_p30.json',
...
log_level = 'INFO'
load_from = 'out/oln_box_ships/round0/warship_cz_hybrid_lc75_r0/latest.pth'
resume_from = None
workflow = [('train', 1)]

work_dir='./out/oln_box_ships/round1/restricted_warship_cz_hybrid_lc75_lateqflwbbl2_r1_p30'

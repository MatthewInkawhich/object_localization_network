...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round0/warship_cz_r0/filter100_annotations_for_round1_p30.json',
...
work_dir='./out/oln_box_ships/round1/filter100_warship_cz_lateqflwbbl2_noft_r1_p30'

...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round0/warship_cz_r0/filter75_annotations_for_round1_p100.json',
...
work_dir='./out/oln_box_ships/round1/filter75_warship_cz_lateqflwbbl2_noft_r1_p100'

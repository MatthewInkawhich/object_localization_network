...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round1/merchant_cz_lateqflwbbl2_noft_r1_p30/annotations_for_round2_p30.json',
...
work_dir='./out/oln_box_ships/round2/merchant_cz_lateqflwbbl2_noft_r2_p30_p30'

...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round1/warship_cz_lateqflwbbl2_noft_r1_p50/annotations_for_round2_p50.json',
...
work_dir='./out/oln_box_ships/round2/warship_cz_lateqflwbbl2_noft_r2_p50_p50'

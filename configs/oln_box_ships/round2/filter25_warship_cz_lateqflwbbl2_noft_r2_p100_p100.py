...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round1/filter25_warship_cz_lateqflwbbl2_noft_r1_p100/filter25_annotations_for_round2_p100.json',
...
work_dir='./out/oln_box_ships/round2/filter25_warship_cz_lateqflwbbl2_noft_r2_p100_p100'

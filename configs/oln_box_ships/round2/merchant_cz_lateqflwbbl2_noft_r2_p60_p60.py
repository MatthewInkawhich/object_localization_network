...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        ann_file='out/oln_box_ships/round1/merchant_cz_lateqflwbbl2_noft_r1_p60/annotations_for_round2_p60.json',
...
work_dir='./out/oln_box_ships/round2/merchant_cz_lateqflwbbl2_noft_r2_p60_p60'

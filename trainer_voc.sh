...
bash tools/dist_train.sh configs/oln_box/round1/voc_cz_lateqflwbbl2_2x_r1_p30.py 4
...
### Round 2
bash tools/dist_collect_preds.sh configs/oln_box/round1/voc_cz_lateqflwbbl2_2x_r1_p30.py out/oln_box/round1/voc_cz_lateqflwbbl2_2x_r1_p30/latest.pth 0.6 1 4
python tools/merge_annotations_by_percent.py data/coco/annotations/instances_train2017.json out/oln_box/round1/voc_cz_lateqflwbbl2_2x_r1_p30/preds_round1.bbox.json 'voc' .30

bash tools/dist_train.sh configs/oln_box/round2/voc_cz_lateqflwbbl2_2x_r2_p30_p30.py 4
...
### Round 3
bash tools/dist_collect_preds.sh configs/oln_box/round2/voc_cz_lateqflwbbl2_2x_r2_p30_p30.py out/oln_box/round2/voc_cz_lateqflwbbl2_2x_r2_p30_p30/latest.pth 0.6 2 4
python tools/merge_annotations_by_percent.py data/coco/annotations/instances_train2017.json out/oln_box/round2/voc_cz_lateqflwbbl2_2x_r2_p30_p30/preds_round2.bbox.json 'voc' .30

bash tools/dist_train.sh configs/oln_box/round3/voc_cz_lateqflwbbl2_2x_r3_p30_p30_p30.py 4

...
class CocoUSplitDataset(CocoDataset):
    ...
    def __init__(self, 
        ...
        super(CocoUSplitDataset, self).__init__(**kwargs)
    ...
    VOC10_CLASSES = (
               ...
               'chair', 'cow', 'dog', 'person', 'tv', 'UNKNOWN')
    NONVOC10_CLASSES = (
    ...
    OUTDOOR_CLASSES = (
               ...
               'stop sign', 'parking meter', 'bench', 'UNKNOWN')
    NON_OUTDOOR_CLASSES = (
    ...
    SPORTS_CLASSES = (
               'frisbee',
               'skis', 'snowboard', 'sports ball', 'kite', 'baseball bat',
               'baseball glove', 'skateboard', 'surfboard', 'tennis racket', 'UNKNOWN')
    NON_SPORTS_CLASSES = (
               'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
               'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
               'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
    ...
    KITCHEN_CLASSES = (
               'bottle', 'wine glass', 'cup', 'fork', 'knife', 'spoon', 'bowl', 'UNKNOWN')
    NON_KITCHEN_CLASSES = (
               'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
               'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
               'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
    ...
    FOOD_CLASSES = (
               'banana', 'apple', 'sandwich', 'orange', 'broccoli', 'carrot',
               'hot dog', 'pizza', 'donut', 'cake', 'UNKNOWN')
    NON_FOOD_CLASSES = (
               'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
               'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
               'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
    ...
    FURNITURE_CLASSES = (
               'chair', 'couch', 'potted plant', 'bed', 'dining table', 'toilet', 'UNKNOWN')
    NON_FURNITURE_CLASSES = (
               ...
               'bottle', 'wine glass', 'cup', 'fork', 'knife', 'spoon', 'bowl',
               'banana', 'apple', 'sandwich', 'orange', 'broccoli', 'carrot',
               'hot dog', 'pizza', 'donut', 'cake', 'tv', 'laptop',
               'mouse', 'remote', 'keyboard', 'cell phone', 'microwave',
               'oven', 'toaster', 'sink', 'refrigerator', 'book', 'clock',
               'vase', 'scissors', 'teddy bear', 'hair drier', 'toothbrush')
    ...
    ELECTRONIC_CLASSES = (
               'tv', 'laptop', 'mouse', 'remote', 'keyboard', 'cell phone', 'UNKNOWN')
    NON_ELECTRONIC_CLASSES = (
               'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
               'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
               'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
               'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra', 'giraffe',
               ...
               'banana', 'apple', 'sandwich', 'orange', 'broccoli', 'carrot',
               'hot dog', 'pizza', 'donut', 'cake', 'chair', 'couch',
               'potted plant', 'bed', 'dining table', 'toilet', 'microwave',
               'oven', 'toaster', 'sink', 'refrigerator', 'book', 'clock',
               'vase', 'scissors', 'teddy bear', 'hair drier', 'toothbrush')


    APPLIANCE_CLASSES = (
               'microwave', 'oven', 'toaster', 'sink', 'refrigerator', 'UNKNOWN')
    NON_APPLIANCE_CLASSES = (
               'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
               'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
               'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
               'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra', 'giraffe',
    ...
    INDOOR_CLASSES = (
               'book', 'clock', 'vase', 'scissors', 'teddy bear', 'hair drier', 'toothbrush', 'UNKNOWN')
    NON_INDOOR_CLASSES = (
               'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
               'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
               'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
    ...
    class_names_dict = {
        ...
        'nonsports': NON_SPORTS_CLASSES,
        'kitchen': KITCHEN_CLASSES,
        'nonkitchen': NON_KITCHEN_CLASSES,
        'food': FOOD_CLASSES,
        'nonfood': NON_FOOD_CLASSES,
        'furniture': FURNITURE_CLASSES,
        'nonfurniture': NON_FURNITURE_CLASSES,
        'electronic': ELECTRONIC_CLASSES,
        'nonelectronic': NON_ELECTRONIC_CLASSES,
        'appliance': APPLIANCE_CLASSES,
        'nonappliance': NON_APPLIANCE_CLASSES,
        'indoor': INDOOR_CLASSES,
        'nonindoor': NON_INDOOR_CLASSES,
    }

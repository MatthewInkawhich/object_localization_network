...
### Round 1
#python -u tools/merge_annotations_by_percent.py data/coco/annotations/instances_train2017.json out/oln_box/round0/animal_cz_2x_r0/preds_round0.bbox.json 62566 .30 --restricted 'animal'
...
python tools/merge_annotations_by_percent.py data/coco/annotations/instances_train2017.json out/oln_box/round1/restricted_animal_cz_lateqflwbbl2_2x_r1_p30/preds_round1.bbox.json 62566 .30 --restricted 'animal'
...
python tools/merge_annotations_by_percent.py data/coco/annotations/instances_train2017.json out/oln_box/round2/restricted_animal_cz_lateqflwbbl2_2x_r2_p30_p30/preds_round2.bbox.json 62566 .30 --restricted 'animal'
